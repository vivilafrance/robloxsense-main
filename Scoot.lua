...
local Library do
    ...
    local Components = { } do
        ...
        Components.Colorpicker = function(self, Data) -- poetry warning (￯﾿ﾢ￯ﾾﾕ￯ﾾﾯ￯﾿ﾂ￯ﾾﾰ￯﾿ﾢ￯ﾾﾖ￯ﾾﾡ￯﾿ﾂ￯ﾾﾰ)￯﾿ﾢ￯ﾾﾕ￯ﾾﾯ
            local Colorpicker = {
                IsOpen = false,
    ...
    Library.KeybindList = function(self)
        ...
        local Items = { } do
            Items["KeybindList"] = Instances:Create("Frame", {
                ...
                Name = "\0",
                AnchorPoint = Vector2New(0, 0.5),
                Position = UDim2New(0, 1780, 0.5, 55),
                BorderColor3 = FromRGB(12, 12, 12),
